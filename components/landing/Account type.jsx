...
export default function Pricing() {
  ...
  return (
    <section className="relative lit-bg  pt-[71px] pb-[81px] font-ebrima">
      <div className=" rounded-[20px] border-[0.5px] border-[#045102] ">
        {/* Header */}
        <div
        ...
        "
        >
          <h2 className="font-[500] text-[40px] text-center mt-8">
          ...
          <div className="flex w-[130px] mx-auto justify-between  bg-[rgba(0,28,5,1)] mt-[18px]  rounded-sm">
            <button
              ...
              className={`rounded-[5px]  px-2 ml-0 text-gray-500  ${
                billing === "monthly"
            ...
            <button
              ...
              className={`rounded-[5px] px-2 text-gray-500 ${
                billing === "annual"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 mt-[26px] gap-3  p-[55px] ">
          {plans.map((plan, i) => (
            <div
              key={i}
              className={`flex flex-col p-3 rounded-[20px] bg-gradient-to-b from black to-[rgba(10,69,18,0.85)] border ${
                plan.highlighted
                  ? "border-[rgb(15,108,12)]"
                  : "border-[rgba(47,194,43,0.2)]"
              }
        ...
        `}
            >
              <div className="">
                ...
                <h3 className="font-medium text-[20px] text-[rgba(255,255,255,1)] pt-2 tracking-wide">
                  {plan.title}
                </h3>
              ...
              <div className="mt-[10px] text-center">
                <span className="font-bold  text-[30px] text-[rgba(255,255,255,1)] font-sans ">
                  {plan.price} <br />
                </span>
                <div className="mt-[-10px]  text-center">
                  <span className="font-normal text-[12px] text-[rgba(255,255,255,0.65)]">
                    {plan.per}
                  </span>
                </div>
              </div>
              ...
              <button
                className={`text-xs rounded-[7px] border-1 py-[2px] px-[20px]   gap-[10px] mt-[10px] group-hover:bg-[rgba(47,194,43,1)] group-hover:h-[36px] group-hover:border-none group-hover:font-medium group-hover:text-[12px] group-hover:text-white transition-all duration-500 cursor-pointer ${
                  plan.highlighted
              ...
              <ul className="mt-[10px]  text-sm text-gray-300">
                <div className="">
                  <span className="font-medium text-[12px] text-[rgba(255,255,255,1)]">
                    {plan.thing}
                  </span>
                </div>
                {plan.features.map((feature, idx) => (
                  <li
                    key={idx}
                    className="flex  items-center gap-2 font-normal text-[8.5px] mt-[4px] "
                  >
