...
const features = [
  ...
  },
  {
    ...
    content:
      "Place service requests from anywhere with data protection and privacy built in.",
  },
  {
    id: 4,
...
export default function One() {
  return (
    <section className=" gap-[10px] min-h-[518px]">
      <h2 className="text-center font-[500] text-[40px] leading-[100%] tracking-[0%] text-[#FFFFFF]">
        One Platform,{" "}
        <span className="relative inline-block">
          Endless
          <img
            className="absolute left-0 bottom-[-11px] w-[167px] h-[10.71px]"
            src="/vector-2.png"
            alt=""
          />
        </span>{" "}
      ...
      <p className="text-center font-[400]  mt-5 text-[14px] leading-[100%] tracking-[0%] text-[#FFFFFFB2]">
        From individuals to businesses,{" "}
        <span className="font-[700] text-sm leading-[100%] tracking-[0%] text-[rgba(47,194,43,1)]">
          CRETESPACE
        </span>{" "}
        puts all your essential tools and services in one secure platform.
      </p>
      <div className=" grid md:grid-cols-3 gap-[12px] mt-[44px]">
        {features.map((item, i) => (
          <div
            key={i}
            className="relative p-5 h-[161px] rounded-[10px] m-auto block border-1 border-[rgb(4,59,3)] "
          >
            ...
            <img
              className="right-5 absolute bottom-5 object-coner"
              src={item.icon}
              width={26}
              height={26}
              alt=""
