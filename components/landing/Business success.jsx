...
const businessSuccessStories = [
  ...
  },
  {
    ...
    quote:
      "From cloud storage to virtual meetings, CRETESPACE has streamlinedour admin processes. We’ve cut down on overhead costs while gettingmore done in less time",
    name: "Samuel Ofor",
  ...
  },
  {
    ...
    quote:
      "CRETESPACE has completely changed how we handle admin work. From document formatting to team collaboration and cloud storage, and welove it!",
    name: "Tunde Adeboye",
...
export default function Business() {
  return (
    <section className="pt-[30px]  pb-[58px]  gap-[46px] bg-[rgba(0,0,0,1)] ">
      <h3 className="text-center font-[500] text-[40px] font-helvetica">
        <span className="text-[#2FC22B]">Business</span> Success Stories
      </h3>
      <div className="p-[2px] gap-[30px] grid md:grid-cols-3 mt-[48px]">
        {businessSuccessStories.map((story, i) => (
          <div
            key={i}
            className="flex flex-col gap-[8px]  px-[17px] py-[27px]  h-[414.95px] rounded-[15.84px] border-1 border-[rgba(255,255,255,0.3)] bg-[rgba(23,23,23,1)]"
          >
            <Image
              width={28}
              height={28}
